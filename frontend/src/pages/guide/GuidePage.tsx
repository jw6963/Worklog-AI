    ...
    <div className="guide-layout">
      ...
      <div className="guide-content">
        ...
        <section id="review">
          ...
          <ul><li>완료·미완료·메모 수와 완료율의 이전 기간 대비 변화를 표시합니다.</li><li>오래 남은 할 일을 누르면 해당 날짜의 원문 항목으로 이동합니다.</li><li>자주 기록한 주제는 외부 AI 없이 단어 빈도를 기준으로 계산합니다.</li><li>기간 분석은 주요 프로젝트와 주제, 완료 결과, 완료율과 TODO 체류 기간을 활동·결과·평가로 나누어 보여줍니다.</li></ul>
