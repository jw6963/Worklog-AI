    ...
    <div className="guide-layout">
      ...
      <div className="guide-content">
        ...
        <section id="projects">
          ...
          <ul><li>프로젝트 카드에서 남은 일·완료·메모 수와 최근 활동을 확인합니다.</li><li>최근 활동을 누르면 해당 날짜의 원문 항목으로, 기록 모아보기를 누르면 프로젝트 필터가 적용된 모아보기로 이동합니다.</li><li><code>···</code> 메뉴에서 이름·색상 수정, 닫기, 삭제와 다른 진행 중 프로젝트로의 항목 이관을 실행합니다.</li><li>프로젝트를 닫으면 기존 기록은 유지되지만 새 항목에는 지정할 수 없으며, 필요할 때 다시 열 수 있습니다.</li><li>이관은 이월 이력을 포함한 모든 연결 항목의 프로젝트를 한 번에 변경합니다.</li><li>프로젝트를 삭제해도 일지 항목은 남고 프로젝트 연결만 해제됩니다.</li></ul>
