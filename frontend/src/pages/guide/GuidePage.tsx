  ...
  return <main className="page guide-page">
    ...
    <div className="guide-layout">
      ...
      <div className="guide-content">
        ...
        <section id="backup">
          <span>05</span><h2>백업과 복원</h2>
          <p>Markdown은 읽고 공유하기 위한 일지 단위 파일이고, JSON은 계정의 전체 데이터를 복원하기 위한 백업 파일입니다.</p>
          <ul><li>중요한 변경 전과 최소 주 1회 전체 JSON 백업을 권장합니다.</li><li>백업 파일은 로컬과 허용된 클라우드 두 곳에 보관합니다.</li><li>Render 무료 PostgreSQL 만료 전에는 반드시 마지막 JSON 백업을 확인합니다.</li></ul>
