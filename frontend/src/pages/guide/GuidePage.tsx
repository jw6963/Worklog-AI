    ...
    <div className="guide-layout">
      ...
      <div className="guide-content">
        ...
        <section id="review">
          ...
          <ul><li>완료·미완료·메모 수와 완료율의 이전 기간 대비 변화를 표시합니다.</li><li>오래 남은 할 일을 누르면 해당 날짜의 원문 항목으로 이동합니다.</li><li>자주 기록한 주제는 외부 AI 없이 의미 있는 2~24자 단어의 빈도로 계산하며, 숫자·반복·과도하게 긴 토큰은 제외합니다.</li><li>기간 분석은 업무량, 완료 흐름, 기록 습관, 프로젝트 집중도, 회고 습관, 지연 업무와 분류 상태를 여러 구간으로 세분화해 평가합니다.</li><li>종합 평가는 개별 신호의 균형을 요약하며 개인의 실제 성과점수나 인사평가를 의미하지 않습니다.</li></ul>
